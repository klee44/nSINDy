...
for i in range(n_train):
	...
	sol = odeint(hyperbolic_rhs_torch,x_init,t,method='dopri5').to(device).squeeze().detach().numpy()
	train_data[i, :, :] = sol
...
np.savez('hyperbolic_torch_noise2.npz', train_data=train_data,val_data=val_data,test_data=test_data)
