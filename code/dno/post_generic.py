...
print(odefunc.D_M.detach().numpy())
print(odefunc.L_M.detach().numpy())
...
print(((test_sol[target_id,1:,2] - test_sol[target_id,:-1,2])<0).any())
print(((test_sol[target_id,1:,2] - test_sol[target_id,:-1,2]<0)).tolist())
...
plt.margins(0,0.04)
plt.title('Damped nonlinear oscillator - GENERIC nSINDy')
#plt.tight_layout()
