...
from lib.odefunc import ODEfunc, ODEfuncHNN
...
plt.margins(0,0.04)
plt.title('Ideal mass spring')
#plt.tight_layout()

save_file = os.path.join(fig_save_path,"mass_spring_example.png")
plt.savefig(save_file)
plt.close(fig)
plt.close('all')
plt.clf()
